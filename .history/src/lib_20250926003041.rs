...
use web_sys::{Event, HtmlCanvasElement, MouseEvent, WebGlProgram, WebGlRenderingContext, WebGlShader};
...
pub fn start() -> Result<(), JsValue> {
    ...
    canvas.add_event_listener_with_callback("Mouse",&cb.as_ref().unchecked_ref());
