...
use web_sys::{WebGlRenderingContext, HtmlCanvasElement, WebGlShader, WebGlProgram,MouseEvent};
...
pub fn start() -> Result<(), JsValue> {
    ...
    pub fn mouse (e:MouseEvent){
        println!("Mouse event: {:?}",e);
    }
    canvas.add_event_listener_with_callback(Mouse, mouse);
