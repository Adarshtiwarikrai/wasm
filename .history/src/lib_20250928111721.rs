...
use web_sys::{Event, HtmlCanvasElement, MouseEvent, WebGlProgram, WebGlRenderingContext, WebGlShader,CanvasRenderingContext2d};
...
pub fn start() -> Result<(), JsValue> {
    ...
    let context=canvas.get_context("2d"). .get_context("2d")
